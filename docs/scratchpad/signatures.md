...
(See also [https://mailarchive.ietf.org/arch/msg/openpgp/C0P4MxwqJBbxS6H0YoXFF3oEJ3A/](this openpgp mailing list post).)
...
As suggested in [https://dkg.fifthhorseman.net/blog/gpg-ask-cert-level-considered-harmful.html](this blog post by DKG), we wish to tighten up their semantics:
